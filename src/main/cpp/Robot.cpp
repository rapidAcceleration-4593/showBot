...
class Robot : public frc::TimedRobot {
  ...
  rev::SparkMaxRelativeEncoder m_leftShooterEncoder = m_shooterLeft.GetEncoder();
  rev::SparkMaxRelativeEncoder m_rightShooterEncoder = m_shooterRight.GetEncoder();
 ...
 public:
  ...
  void TeleopPeriodic() override {
    ...
    m_drivetrain.ArcadeDrive(m_driverController.GetLeftX(), -m_driverController.GetRightY());
